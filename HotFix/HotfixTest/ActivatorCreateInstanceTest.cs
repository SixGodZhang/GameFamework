...
namespace TestCases
{
    ...
    class ActivatorCreateInstanceTest
    {
        public static void ActivatorCreateInstanceWithArgsTest()
        {
            ...
            UnityEngine.Debug.Log($"Create without args: {inst}");
            ...
            UnityEngine.Debug.Log($"Create with args 2: {inst}");
